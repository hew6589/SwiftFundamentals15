...
["North Carolina": Raleigh, "Tennessee": Nashville, "South Carolina": Columbia]
if North Carolina = Raleigh {
print("North Carolina's capital is Raleigh")
}
if Tennessee = Nashville {
print("Tennessee's capital is Nashville")
}
if South Carolina = Columbia {
print("South Carolina's capital is Columbia")
}
