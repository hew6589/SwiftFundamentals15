...
struct somePlace {
 var latitude: Double = 51.514004
 var longitude: Double = 0.125226
}
...
struct someoneHeight {
 var heightInInches: Double = 65
 var heightInCentimeters: Double = 165.1
...
struct myHeight {
 var heightInInches: 58
 var HeightInCentimeters: 147.32
}
