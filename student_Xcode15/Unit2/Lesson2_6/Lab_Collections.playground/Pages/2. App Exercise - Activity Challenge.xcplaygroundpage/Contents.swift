 ...
 */ var challenges = ["walking"]
    var challenges = ["running"]
...
challenges.insert("Walk 3 miles a day')
...
if isEmpty {
 ...
 print("The challenge you have chosen is weightlifting")
} else { 
 print("You have chosen multplie challenges.")
}
