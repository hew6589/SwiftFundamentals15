...
let heartRate2 = 80
let heartRate3 = 90
let addedHR = heartRate1 + heartRate2 + heartRate3 // addedHR has a vaule of 240
let averageHR = addedHR / 3 // averageHR has a value of 80
...
let heartRate2D = 80
let heartRate3D = 90
let addedHRD = heartRate1D + heartRate2D + heartRate3D // addedHRD has a value of 240
let averageHRD = addedHRD / 3 // averageHRD has a value of 80
No, this is not different from the previous average because it is using the same three values. 
...
let percentOfGoal = goal / steps // percentOfGoal has a value of 2.88
