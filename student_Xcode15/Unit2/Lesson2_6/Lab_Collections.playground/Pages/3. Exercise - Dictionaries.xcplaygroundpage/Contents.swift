 ...
 */
var myDictionary = ["January": 31, "February": 28, "March": 31]
print("myDictionary")

//:  Using subscripting syntax to add April to the collection with a value of 30. Print the dictionary.
var myDictionary = ["April": 30]
print("myDictionary")



//:  It's a leap year! Update the number of days in February to 29 using the `updateValue(_:, forKey:)` method. Print the dictionary. 
if let oldValue = myDictionary.updateValue(29, forKey: "February") {
 print("February's old value was \(28)")
}
...
var shapesArray = ["triangle"]
var colorsArray = ["Blue"]
print("shapesArray" and "colorsArray")
